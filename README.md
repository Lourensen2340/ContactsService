...
5. Если хотим поменять роль зарегестрированого пользователя выбираем /api/v1/admin/assign-role вводим айдишник пользователя и ROLE_ADMIN или USER
6. Так же есть возможность создания удаления и просмотра контактов
