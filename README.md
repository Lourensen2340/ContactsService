...
3. далее полученный acsessToken вводим в autorize теперь мы можем создать и изменять удалять и просматривать контакт независимо от роли
...
5. выбираем /api/v1/admin/assign-role вводим айдишник пользователя и ROLE_ADMIN или ROLE_USER
